...
function renderProduct(product) {
    let contents = `
        <tr>
            ...
            <td>
                <img width="120" height="80" src="assets/img/${product.image}">
            </td>
            <td>${product.productName}</td>
            <td>${product.idcategory === "0" ? "Thịt" : product.idcategory === "1" ? "Cá" : product.idcategory === "2" ? 
                "Rau" : product.idcategory === "3" ? "Nước mắm" : product.idcategory === "4" ? "Mì" : product.idcategory === "5" ? 
                "Sữa tươi" : product.idcategory === "6" ? "Trứng" : "Nước ngọt"}
            </td>
...
function renderCustomerProductInfo(order) {
    ...
    products.forEach(p => {
        ...
        <tr>
            <td>
                <img width="50" height="25" src="./assets/img/${p.image}" alt="">
            </td>
            <td>
              ${p.productName}  
            </td>
